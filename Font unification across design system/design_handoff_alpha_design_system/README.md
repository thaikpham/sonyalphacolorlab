...
| 03 | Sony Wiki · Tra cứu máy ảnh | `Alpha Screens.dc.html` §03 | `src/app/[locale]/cameras/` grid (facet sidebar removed) |
...
| 06 | Site header · thanh nav động | `Alpha Screens.dc.html` §06 | `src/components/site-header.tsx` |
...
`CHANGES-v2.1.md` — what changed after the first handoff (screens 03 and 06). Read it
with the plan; where the two disagree, `CHANGES-v2.1.md` wins.
