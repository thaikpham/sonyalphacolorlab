...
export const ARTICLES: readonly Article[] = [
  {
    ...
    archetype: 'versus',
    read: '6 phút đọc',
    title: 'ST hay PT: chọn Creative Look nào cho ảnh chân dung',
    dek: 'Hai lựa chọn an toàn nhất trong danh sách Creative Look, khác nhau ở đúng ba thứ — và vì sao VV không nằm trong danh sách đó.',
    blocks: [
      {
        t: 'tldr',
        items: [
          'Chụp người ngoài trời, muốn da mềm và hồng hào: PT.',
          'Chụp lẫn cảnh, đồ ăn, đường phố, hoặc còn muốn chỉnh lại sau: ST.',
          'Tránh VV cho ảnh có người — nó đẩy độ bão hòa lên trước cả khi bạn kịp nhìn tông da.',
        ],
      },
      {
        t: 'p',
        text: 'Creative Look (máy đời mới) hay Creative Style (máy đời cũ) là bộ công thức xử lý ảnh máy áp vào file JPEG: độ tương phản, độ bão hòa, độ nét và cách xử lý tông màu da. Nếu bạn chụp JPEG, đây là màu cuối cùng của ảnh — không phải một bộ lọc gỡ ra được.',
      },
      {
        t: 'menu',
        old: 'MENU → Camera Settings1 → Creative Style',
        new: 'MENU → Exposure/Color → Color/Tone → Creative Look',
      },
      { t: 'h', text: 'Ba khác biệt thật sự' },
      {
        t: 'p',
        text: 'Bỏ qua mô tả marketing, ST và PT chỉ khác nhau ở tương phản, bão hòa và cách dựng tông da. PT hạ tương phản ở vùng sáng nên da không bị cháy thành mảng trắng, giảm bão hòa nhẹ để da không đỏ, và đẩy tông da hơi ấm về phía hồng.',
      },
      {
        t: 'table',
        head: ['Tiêu chí', 'ST (Standard)', 'PT (Portrait)'],
        caption: 'So sánh tương đối, đúng với ảnh JPEG chụp trực tiếp từ máy.',
        rows: [
          ['Tương phản', 'Trung tính', 'Mềm hơn ở vùng sáng'],
          ['Độ bão hòa', 'Trung tính', 'Thấp hơn một chút'],
          ['Tông da', 'Trung thực', 'Ấm và hồng hơn'],
          ['Độ nét', 'Vừa', 'Mềm hơn — có lợi cho da'],
          ['Dùng cho', 'Mọi thứ, kể cả cảnh và đồ ăn', 'Chân dung, ảnh có người là chính'],
        ],
      },
      {
        t: 'compare',
        beforeLabel: 'ST',
        afterLabel: 'PT',
        caption: 'Kéo thanh để so sánh cùng một khung chụp bằng hai Creative Look.',
      },
      { t: 'h', text: 'Chỉnh trong Look, đừng đổi Look' },
      {
        t: 'p',
        text: 'Mỗi Look còn tám tham số con (Contrast, Highlights, Shadows, Fade, Saturation, Sharpness, Sharpness Range, Clarity). Khi ảnh chưa vừa ý, chỉnh tham số của Look đang dùng thay vì nhảy sang Look khác — bạn giữ được một điểm khởi đầu quen mắt qua nhiều buổi chụp, thay vì mỗi buổi một màu.',
      },
      {
        t: 'callout',
        label: 'Nếu bạn chụp RAW',
        text: 'Creative Look chỉ ảnh hưởng ảnh xem trước trong máy và file JPEG kèm theo. RAW vẫn giữ nguyên dữ liệu — nhưng đặt PT vẫn có ích, vì ảnh xem lại trên máy sát hơn với thành phẩm bạn hình dung.',
      },
      {
        t: 'checklist',
        label: 'Kiểm tra trước buổi chụp',
        items: [
          'Đặt Look về ST hoặc PT (không phải VV/VV2)',
          'Reset các tham số con về 0 nếu buổi trước từng chỉnh',
          'Chụp thử một khung có mặt người, xem lại ở mức phóng 100%',
          'Nếu da đỏ: giảm Saturation một bậc, đừng giảm Contrast',
        ],
      },
      {
        t: 'figure',
        alt: 'Bảng Creative Look trên màn hình máy ảnh',
        caption:
          'Bảng Creative Look trên máy — thứ tự các Look giống nhau giữa hai phiên bản menu, chỉ khác đường dẫn tới nó.',
      },
    ],
  },
  {
